...
| 4.4 | `/admin`: наполненность данных, генератор бэкфила, ссылки на телеметрию, логи | pulse-api | ☑ |
| 4.5 | `/admin`: выпуск API-ключей с уровнями доступа (admin/maintenance/api_only) прямо из панели | pulse-api | ☑ |
